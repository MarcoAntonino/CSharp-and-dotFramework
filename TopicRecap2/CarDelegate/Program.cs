...
namespace CarDelegate
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Inoltre RegisterWithCarEngine si aspetta un'istanza di CarEngineHandler che a sua volta contiene il meotod che verrà caricato in essa. Ecco perchè troviamo scritto new Car.CarEngineHandler(onCarEngineEvent)
